...
export function PricingSection() {
  ...
  return (
    <section id="pricing" className="py-40 relative overflow-hidden bg-black/10 border-y border-white/5">
      {/* Background Glow */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-primary/5 blur-[200px] pointer-events-none" />
