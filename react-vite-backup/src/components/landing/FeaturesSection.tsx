...
export function FeaturesSection() {
  ...
  return (
    <section id="features" className="py-40 relative overflow-hidden border-y border-white/5">
      {/* Subtle Background Accent */}
      <div className="absolute top-0 left-1/4 w-[500px] h-[500px] bg-primary/5 blur-[150px] pointer-events-none" />
