...
export function TestimonialsSection() {
  ...
  return (
    <section id="testimonials" className="py-40 relative overflow-hidden border-y border-white/5">
      {/* Background Glow */}
      <div className="absolute top-1/2 left-0 w-[500px] h-[500px] bg-primary/5 blur-[150px] pointer-events-none" />
