...
export function BenefitsSection() {
  ...
  return (
    <section id="benefits" className="py-40 relative overflow-hidden bg-black/20 industrial-grid border-b border-white/5">
      {/* Decorative Background */}
      <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-primary/5 blur-[180px] pointer-events-none" />
